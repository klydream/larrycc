    ...
    public class RestorationShamanCombatClass : KingWoWAbstractBaseClass
    {
        ...
        private bool HealingRain(bool lockframe)
        {
            ...
            if ((!Me.IsMoving || utils.isAuraActive(SPIRIT_WALK)) && utils.CanCast(HEALING_RAIN))
            {
                ...
                {
                    hr_target = utils.BestHealingRainTargetLocation(RestorationShamanSettings.Instance.HealingRainPercent, RestorationShamanSettings.Instance.HealingRainNumber);
                }
                if (hr_target != null)
                {
        ...
        public override bool Pull
        {
            get
            {
                ...
                {
                    if (!target.InLineOfSpellSight || target.Distance > RestorationShamanSettings.Instance.PullDistance)
                    {
        ...
        private bool Self()
        {
            if (Me.HealthPercent <= RestorationShamanSettings.Instance.ShamanistcRageHP && utils.CanCast(SHAMANISTIC_RAGE))
            {
        ...
        private bool Healing()
        {
            ...
            if (Me.CurrentTarget != null && Me.CurrentTarget.IsFriendly && Me.CurrentTarget.IsValid
                ...
                && healTarget.HealthPercent > RestorationShamanSettings.Instance.HealNPC_threshold)
            ...
            if ( ((healTarget!=null && healTarget.HealthPercent >= 90) || healTarget == null) && RestorationShamanSettings.Instance.LB_for_rec_mana && talents.HasGlyph("Telluric Currents"))
            {
        ...
        private bool Cleansing()
        {
            ...
            {
                WoWPlayer player = utils.GetDispellTargetShammyNotResto(40f);
